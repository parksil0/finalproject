...
<body>
	...
	<div class="mainInner">
		...
		<div class="mypageTable mypageNone" id="mypageUpdateName">
		...
		<div class="mypageTable mypageNone" id="mypageUpdatePwd">
		...
		<div class="mypageTable mypageNone" id="mypageWithdrawal">
