		...
		success: function(data) {
			//console.log('data : ' + JSON.stringify(data));
				if(auth == '관리자') {
					...
					getPrjHtml += '<tr><th>이름</th><td><input type="text" name="prjName" id="prjName" value="'+data.name+'"></td></tr>';
				...
				if(auth == '멤버' || data.status == '완료') {
					...
					getPrjHtml += '</td></tr>';
					getPrjHtml += '<tr><th>관리자</th><td><input type="text" name="memName" id="memName" value="'+data.g_name+'" readonly></td></tr>';				
					getPrjHtml += '<tr><th>기간</th><td>';
...
$(document).ready(function(){
	...
	$("#searchBtn").on("click", function(){
		...
		$.ajax({
			url: '/biz/searchProject.do?type='+type+'&keyword='+keyword,
			type: 'get',
			success: function(data) {
